  ...
  return (
    <div className={`about-page ${theme === 'dark' ? 'dark' : ''}`}>
      ...
      <section className="about-section">
        ...
        <p>
          Konverter is a modern web application designed to help developers and data analysts
          easily convert between different data formats. Whether you're working with CSV files,
          JSON data, or need to minify your code, Konverter provides a simple and efficient solution.
        </p>
      </section>
      ...
      <section className="developer-section">
        ...
        <div className="developer-info">
          <p>
            <strong>Developer:</strong> Mr Heritage
          </p>
          <p>
          ...
          <p>
            <strong>Technologies Used:</strong> React, JavaScript Libraries, CSS3, Vite
          </p>
        </div>
      </section>
      ...
      <div className="navigation-buttons">
        ...
        <Link to="/converter" className="secondary-button">
          Try Converter
        </Link>
      </div>
    </div>
